...
class QueryRouter:
    ...
    def _create_model_mapping(self):
        return config.MODEL_LEVELS
    
    def route_query_and_return_response(self, query: str, use_cache: bool = True) -> QueryResponse:
        ...
        self._cache_response(query, response, final_model, complexity, use_cache)
    ...
    def _check_cache(self, query: str, use_cache: bool) -> Optional[QueryResponse]:
